# Generated by Django 2.1.2 on 2018-11-05 12:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bank', models.CharField(choices=[('Standard Chartered', 'Standard Chartered'), ('KCB', 'KCB'), ('Equity', 'EQUITY')], default='', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.AddField(
            model_name='account',
            name='bank',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='finplanner.Bank'),
        ),
    ]
